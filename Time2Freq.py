...
###################### loading Recreational data
    ...
    path_x1 = 'path of sensorstationaryHK\\top.txt'          # baseline of sensor stationary in top direction
    path_x2 = 'path of sensorstationaryHK\\down.txt'         # baseline of sensor stationary in down direction
    path_y1 = 'path of sensorstationaryHK\\left.txt'         # baseline of sensor stationary in left direction
    path_y2 = 'path of sensorstationaryHK\\right.txt'        # baseline of sensor stationary in right direction
    path_z1 = 'path of sensorstationaryHK\\backside.txt'          # baseline of sensor stationary in backside direction
    path_z2 = 'path of sensorstationaryHK\\frontal.txt'           # baseline of sensor stationary in frontal direction
    ...
    path11 = 'path of sensorstationarySydney\\top.txt'             # baseline of sensor stationary in top direction
    path12 = 'path of sensorstationarySydney\\bottom.txt'          # baseline of sensor stationary in bottom direction
    path13 = 'path of sensorstationarySydney\\left.txt'            # baseline of sensor stationary in left direction
    path14 = 'path of sensorstationarySydney\\right.txt'           # baseline of sensor stationary in right direction
    path15 = 'path of sensorstationarySydney\\back.txt'            # baseline of sensor stationary in back direction
    path16 = 'path of sensorstationarySydney\\front.txt'           # baseline of sensor stationary in front direction
